...
type PartialSelectionOptions = Partial<Omit<SelectionOptions, "behaviour" | "features">> & {
...
export { Quantify, ScrollEvent, ChangedElements, SelectionStore, SelectionEvent, SelectionEvents, AreaLocation, Coordinates, TapMode, OverlapMode, Scrolling, SingleTap, Features, Behaviour, SelectionOptions, PartialSelectionOptions, SelectionArea as default };
